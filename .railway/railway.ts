...
export default defineRailway(() => {
  ...
  const toptier = service("toptier", {
    ...
    start: "mkdir -p /data/db && npx prisma db push --skip-generate --accept-data-loss && node scripts/ensure-admin.js && node scripts/ensure-packages.js && node scripts/ensure-tickers.js && node .next/standalone/server.js",
