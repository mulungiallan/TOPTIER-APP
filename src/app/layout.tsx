...
export const viewport: Viewport = {
  width: "device-width",
  initialScale: 1,
  maximumScale: 1, // prevents pinch-zoom breaking your layout
...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL?.replace(/\/$/, "") || "https://toptier-production.up.railway.app"),
  title: {
  ...
  verification: {
    google: "google8acd419857671d47.html",
  },
  ...
  openGraph: {
    ...
    siteName: "TOPTIER",
    url: (process.env.NEXT_PUBLIC_APP_URL?.replace(/\/$/, "") || "https://toptier-production.up.railway.app") + "/",
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
        height: 630,
        alt: "TOPTIER — AI Trading Signals & Screenshot Analysis",
      },
    ],
    locale: "en_US",
  },
...
export default async function RootLayout({
  ...
  const siteUrl = (process.env.NEXT_PUBLIC_APP_URL?.replace(/\/$/, "") || "https://toptier-production.up.railway.app") + "/";
